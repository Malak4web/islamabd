        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="text-xs text-[#555]">Drag to reorder</span>
                </div>
                        ...
                        <div class="bg-[#141414] border border-[#222] p-6 rounded-2xl flex items-center justify-between group hover:border-[#333] transition-all">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <span v-if="!element.is_active" class="px-2 py-0.5 bg-red-900/20 text-red-500 rounded text-[10px] uppercase font-bold">Hidden</span>
                                    </div>
                            ...
                            <div class="flex items-center gap-3">
                                <button 
                                    ...
                                    :title="element.is_active ? 'Hide Section' : 'Show Section'"
                                >
            ...
            <div class="space-y-8">
                <div class="bg-[#141414] border border-[#222] p-8 rounded-2xl shadow-xl">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-[#888] mb-2">Meta Title</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-[#888] mb-2">Meta Description</label>
                ...
                <div class="bg-white p-6 rounded-2xl">
                    <p class="text-[#1a0dab] text-xl truncate mb-1">{{ seoForm.meta_title || 'Site Title' }}</p>
                    <p class="text-[#006621] text-sm mb-1">indesign-co.com › {{ page?.slug }}</p>
                    <p class="text-[#545454] text-sm line-clamp-2">{{ seoForm.meta_description || 'Page description will appear here...' }}</p>
                </div>
            </div>
        </div>
        ...
        <div v-if="editingSection" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div class="bg-[#141414] border border-[#222] w-full max-w-2xl rounded-2xl overflow-hidden shadow-2xl">
                <div class="p-6 border-b border-[#222] flex justify-between items-center">
                    <h3 class="text-xl font-bold">Edit Section: {{ editingSection.key }}</h3>
                ...
                <div class="p-6 bg-[#1a1a1a] border-t border-[#222] flex justify-end gap-3">
                    <button @click="editingSection = null" class="px-6 py-2 text-[#888] hover:text-white">Cancel</button>
                    <button @click="saveSection" class="px-8 py-2 bg-[#d4af37] text-[#0a0a0a] font-bold rounded-xl">Save Content</button>
                </div>
            </div>
        </div>
    </div>
