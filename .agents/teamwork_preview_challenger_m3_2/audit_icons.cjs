...
vueFiles.forEach(file => {
  ...
  lines.forEach((line, idx) => {
    ...
    // Check for explicit dark mode classes or deprecated colors in template lines
    const darkHexMatches = line.match(/(#141414|#1a1a1a|#2a2a2a|#333333|#333\b|#888888|#888\b|#000000)/ig);
    if (darkHexMatches) {
